...
import { CreateGroupChatDialog } from './chat-create-group-dialog';
...
export default function DataSearchChatTool() {
  ...
  const [data, setData] = useState<object[]>([mockProducts]);
  ...
  return (
    <>
      ...
      {menu === 'home' ? (
        <HomeMenu setMenu={setMenu} setData={setData} setIsChatPanelOpen={setIsChatPanelOpen} />
      ) : (
